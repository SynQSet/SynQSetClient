<#
.SYNOPSIS
    SynQSetClientt buildScript
.DESCRIPTION
    A custom Psake buildScript for the module SynQSetClient.
.LINK
    https://github.com/alainQtec/SynQSetClient/blob/main/build.ps1
.EXAMPLE
...
Begin {
    ...
    $dataFile = [System.IO.FileInfo]::new([IO.Path]::Combine($PSScriptRoot, 'en-US', 'SynQSetClient.strings.psd1'))
    if (!$dataFile.Exists) { throw [System.IO.FileNotFoundException]::new('Unable to find the LocalizedData file.', 'SynQSetClient.strings.psd1') }
